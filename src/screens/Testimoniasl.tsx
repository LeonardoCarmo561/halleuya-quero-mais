      ...
      >
        <View className="flex flex-[1.3] space-y-2">
          <Pressable
            ...
            <Text className="text-white font-[FivoSans-Heavy-Oblique] text-center text-auto">
      ...
      >
        <View className="flex flex-1 space-y-2">
          ...
          <Pressable
            ...
            <Text className="text-white font-[FivoSans-Heavy-Oblique] text-center text-auto">Uma alegria transbordante para o mundo</Text>
          </Pressable>
        </View>
        <Pressable
          ...
          className="
              ...
              "
        >
          <Text className="text-white font-[FivoSans-Heavy-Oblique] text-center text-auto p-6">
